"use client";
import { getMarcajesByUsuarioId } from "@/lib/data-client";
			...
			<div className="flex flex-row items-baseline justify-between">
				...
				<div className="flex gap-2">
					<button
						...
						className="flex items-center gap-2 rounded border border-indigo-700 bg-indigo-600 p-2 text-sm font-medium"
					>
