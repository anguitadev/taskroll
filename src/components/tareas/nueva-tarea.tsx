	...
	return (
		<>
			<div
				...
				popover="auto"
				className="max-w-[calc(100vw-4%)] md:min-w-[900px] overflow-visible rounded-lg border border-neutral-800 p-2 md:p-8 backdrop:brightness-50 backdrop:backdrop-blur-sm"
			>
